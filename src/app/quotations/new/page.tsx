              ...
              {signatureUrl ? (
                ...
                <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-border rounded-lg p-6 cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all min-h-[100px]">
                  ...
                  <input type="file" accept="image/*" className="hidden" onChange={(e) => {
                    ...
                    if (file) { const r = new FileReader(); r.onloadend = () => setSignatureUrl(r.result as string); r.readAsDataURL(file); }
                  }} />
                </label>
              )}
            </div>
            ...
            <div className="space-y-3">
              ...
              {stampUrl ? (
                ...
                <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-border rounded-lg p-6 cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all min-h-[100px]">
                  ...
                  <input type="file" accept="image/*" className="hidden" onChange={(e) => {
                    const file = e.target.files?.[0];
                    if (file) { const r = new FileReader(); r.onloadend = () => setStampUrl(r.result as string); r.readAsDataURL(file); }
                  }} />
                </label>
              )}
            </div>
